const ButtonSvg = (isWhite: boolean) => (
	<>
		<svg
		...
		>
			<path
				...
				stroke={isWhite ? "white" : "url(#btn-left)"} // mentioned in ButtonGradient.jsx
				strokeWidth="2"
		...
		>
			<path
				fill={isWhite ? "white" : "none"}
				stroke={isWhite ? "white" : "url(#btn-right)"} // mentioned in ButtonGradient.jsx
				strokeWidth="2"
