...
import { Section, Button, Generating, Notification } from "./ui";
	...
	return (
		...
		>
			...
			>
				...
				mx-auto text-center mb-[3.875rem] md:mb-20
				lg:mb-[6.25rem]"
				>
					...
					text-n-2 lg:mb-8"
					>
						Unleash the power of AI within Brainwave. Upgrade
						your productivity with Brainwave, the open AI chat
						app.
					</p>
					<Button
						href="#pricing"
